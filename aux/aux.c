...
{ // Inspirado em https://github.com/W1ndeck/SIG-Finance/blob/main/auxiliares/funcoes_auxiliares.c
...
{ // Inspirado em https://github.com/DayXL/Atividade-projeto-bonelaria/blob/main/moduloRelatorio.c
    int tam = del2 - del1;
    int aux = 0;
